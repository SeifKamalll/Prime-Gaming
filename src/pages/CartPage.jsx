...
export default function CartPage() {
    ...
    return (
        <div className="container mx-auto flex flex-col items-center px-4 pb-[15px] lg:py-[40px] font-chau">
            <div className="w-full flex flex-col lg:flex-row justify-center gap-8 pt-20 lg:gap-[48px]">
                <div className="w-full max-h-[500px] flex flex-col gap-[40px]">
                ...
                <div className="w-full lg:max-w-[536px] lg:h-[500px] h-fit border border-[#FF5733] rounded-[10px] px-6 py-8 lg:px-[35px] lg:py-[30px] flex flex-col gap-[30px] bg-transparent">
                    ...
                    <button className="w-full btn rounded-lg h-[56px] bg-[#FF5733] hover:bg-gray-950 border-[#FF5733] text-white">Checkout</button>
                </div>
            </div>
        </div>
    );
