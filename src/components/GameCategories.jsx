...
export default function GameCategories() {
  ...
  return (
    <div className='flex flex-col justify-center items-center h-[254px] w-full gap-[24px] md:h-[449px] lg:h-[527px] lg:gap-[32px] px-2 md:p-0'>
      <div className='flex w-full justify-center items-center h-[36px] md:h-[51px] lg:h-[51px] '>
      ...
      <div className='flex flex-nowrap no-scrollbar overflow-x-auto md:overflow-visible md:grid md:grid-cols-4 md:grid-rows-2 w-full h-[210px] gap-[12px] md:h-[374px] md:gap-[20px] lg:h-[444px] lg:gap-x-[24px] md:px-40'>
