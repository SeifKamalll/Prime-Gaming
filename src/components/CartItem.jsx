...
export default function CartItem({ game }) {
    ...
    return (
        <div className="flex w-full gap-2 items-center">
            <div className="flex justify-center items-center h-25 w-25 border-[#FF5733] border rounded-xl overflow-hidden">
            ...
            <div className="flex w-[431px] h-[88px] justify-between">
                <div className="flex flex-col gap-10">
                    ...
                    <h1 className="font-normal text-[14px] leading-[24px] tracking-normal">Total : $ {game.qty * (game.disprice ? game.disprice : game.price)} </h1>
                </div>
                <div className="flex flex-col w-[110px] h-[88px] gap-[24px]">
                    <div className="flex justify-center items-center gap-10">
                        <h1>${game.disprice ? game.disprice : game.price}</h1>
